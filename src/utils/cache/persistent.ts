/*
 * @Author: bugdr
 * @Date: 2022-05-01 10:35:02
 * @LastEditors: bugdr
 * @LastEditTime: 2022-05-01 10:35:04
 * @FilePath: \blog-admin\src\utils\cache\persistent.ts
 * @Description: 执行器
 */
...
function initPersistentMemory() {
    ...
    sessionCache && localMemory.resetCache(sessionCache)
}
